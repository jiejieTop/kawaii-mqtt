...
其他不需要怎么配置的东西：
```c
#define     KAWAII_MQTT_MAX_PACKET_ID                  (0xFFFF - 1)    // mqtt报文id
#define     KAWAII_MQTT_MAX_CMD_TIMEOUT                20000           //最大的命令超时参数
#define     KAWAII_MQTT_MIN_CMD_TIMEOUT                1000            //最小的命令超时参数
```
